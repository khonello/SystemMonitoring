...
challenge with a placeholder; Phase 6 swaps this one function body for a real
...
# stored ACL-restricted under %ProgramData%. Absent until Phase 6.
...
def load_client_key() -> bytes | None:
    ...
    """
    # TODO(Phase 6): read KEY_FILE, verify ACLs, return the raw key.
    return None
...
def compute_challenge_response(nonce: str) -> str:
    ...
    accepts. Phase 6 replaces the body with:
